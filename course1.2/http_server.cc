        ...
        <div class=\"row\">\
            <div class=\"col mt-3\">\
                ...
                <p>\
                    ...
                    1、本网页的所有操作都需要输入正确的口令。\
                    </span>\
                </p>\
                <p>\
                    <span style=\"font-size:18px\">\
                    2、选课操作使用临时会话cookie登录。获取方式：以谷歌浏览器为例，按F12进入开发者工具，进入network选项卡，然后刷新网页，点击network列表中的最上面的一条记录，名字可能是main，右侧headers中找到request headers中的cookie，获取sepuser和jsessionid的值，双引号全部去掉，记录下来。\
                    </span>\
                </p>\
                <p>\
                    <span style=\"font-size:18px\">\
